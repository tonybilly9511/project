...
<style>
  ...
  .shopcart-wrapper .shopcart-list .list-content .food-list{
    height: 60px;
    padding: 12px 12px 10px 12px;
    border-bottom: 1px solid #f4f4f4;
    box-sizing: border-box;
  }
  .shopcart-wrapper .shopcart-list .list-content .food-list .desc-wrapper{
    float: left;
    width: 240px;
  }
  .shopcart-wrapper .shopcart-list .list-content .food-list .desc-wrapper .desc-left{
    float: left;
    width: 170px;
  }
  .shopcart-wrapper .shopcart-list .list-content .food-list .desc-wrapper .desc-left .name{
    font-size: 16px;
    margin-bottom: 8px;
  ...
  .shopcart-wrapper .shopcart-list .list-content .food-list .desc-wrapper .desc-left .unit{
    font-size: 12px;
    color: #b4b4b4;
  }
  .shopcart-wrapper .shopcart-list .list-content .food-list .desc-wrapper .desc-left .description{
    font-size: 12px;
    color: #b4b4b4;
  ...
  .shopcart-wrapper .shopcart-list .list-content .food-list .desc-wrapper .desc-right{
    float: right;
    width: 70px;
    text-align: right;
  }
  .shopcart-wrapper .shopcart-list .list-content .food-list .desc-wrapper .desc-right .price{
    font-size: 14px;
    line-height: 34px;
  }
  .shopcart-wrapper .shopcart-list .list-content .food-list .cartcontrol-wrapper{
    float: right;
    margin-top: 6px;
  }
